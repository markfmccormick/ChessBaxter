...
def create_constants():
    ...
    # Generate several maps used to translate between different data formats for the same information used throughout the project
    ...
    # The initial piece counts for the starting board position
    ...
    # Load the mapping between squares and Baxter joint positions, for the right arm
    position_map = {}
    ...
    # Generate further static Baxter joint positions used, which aren't squares
    ...
    # The piece classification precedence list
