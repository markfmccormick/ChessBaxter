...
def show_detection(img1, img2, matchesMask, keypoints, new_keypoints, kp1, kp2, good):
...
def get_keypoints(imgpath):
    ...
    if show_detection:
        show_detection(img1, img2, matchesMask, keypoints, new_keypoints, kp1, kp2, good)
